...
class CountryCodeMapperTest {
    ...
    public void testAddCountryCode() {
        ...
        user.add(User.builder().address(Address.builder().geo(Geo.builder().lng(100.0).lat(120.0).build()).build()).build());
        user.add(User.builder().address(Address.builder().geo(Geo.builder().lng(200.0).lat(120.0).build()).build()).build());
        user.add(User.builder().address(Address.builder().geo(Geo.builder().lng(300.0).lat(120.0).build()).build()).build());
